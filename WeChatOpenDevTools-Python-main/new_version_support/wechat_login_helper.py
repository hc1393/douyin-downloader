...
class WeChatLoginHelper:
    ...
    def init_frida(self):
        ...
        try:
            ...
            try:
                ...
                print(Color.RED + f"[-] Frida重新加载失败: {e2}" + Color.END)
                raise e2
    ...
    def generate_login_helper_script(self, config, version):
        """
        生成登录助手脚本
        """
        script_content = f'''
...
function loginHelper() {{
                ...
                onEnter: function(args) {{
                    try {{
                        ...
                        if ((title && (title.includes("微信") || title.includes("WeChat"))) &&
                            ...
                            args[1].writeUtf16String("登录检查已通过，可以正常登录微信");
    ...
    console.log("[+] 微信登录助手已完成所有设置");
    console.log("[*] 请尝试登录微信");
}}

// 立即执行
setImmediate(loginHelper);
'''
    ...
    def attach_and_inject(self, pid, script_content):
        ...
        try:
            ...
            script.load()
            print(Color.GREEN + "[+] 成功注入登录助手脚本!" + Color.END)
    ...
    def run_login_helper(self):
        ...
        运行登录助手
        """
        print(Color.GREEN + "[*] 启动微信登录助手..." + Color.END)
        ...
        # 生成助手脚本
        script_content = self.generate_login_helper_script(config, version)
        ...
        print(Color.GREEN + "[+] 微信登录助手已就绪!" + Color.END)
...
使用方法:
    python wechat_login_helper.py     自动启动微信并处理登录限制
...
/  \    /  \ ____\_ |__ |  |   ____  __ __  __| _/____   ____ |  | |  |  
\   \/\/   // __ \| __ \|  |  /  _ \|  |  \/ __ |/  _ \ /  _ \|  | |  |  
 \        /\  ___/| \_\ \  |_(  <_> )  |  / /_/ (  <_> |  <_> )  |_|  |__
  \__/\  /  \___  >___  /____/\____/|____/\____ |\____/ \____/|____/____/
       \/       \/    \/                      \/                        
        """
        print(Color.GREEN + banner + Color.END)
        print(Color.GREEN + "        微信登录助手" + Color.END)
